...
contract MockTiempoBondDepository is Ownable {
  ...
  struct Bond {
    uint256 payout; // TIFI remaining to be paid
  ...
  function deposit(
    ...
    require(payout >= 10000000, "Mock Bond too small"); // must be > 0.01 TIFI ( underflow protection )
    ...
    /**
            ...
            approved and
            deposited into the treasury, returning (_amount - profit) TIFI
         */
  ...
  function debtRatio() public view returns (uint256 debtRatio_) {
    uint256 supply = IERC20(TIFI).totalSupply();
