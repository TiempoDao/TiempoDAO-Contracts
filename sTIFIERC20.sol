...
contract sTIFI is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Tiempo", "sTIFI", 9) ERC20Permit() {
    ...
    /**
        @notice increases sTIFI supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sTIFI
